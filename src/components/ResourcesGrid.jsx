  ...
  return (
    <Link to={to} className="block">
      <div className={containerClass}>
        <div
          className={`h-48 sm:h-56 flex items-center justify-center overflow-hidden bg-${bg}`}
        >
          <img
            src={image}
            alt={title}
...
function ResourcesGrid() {
  ...
  const items = [
    ...
    {
      title: "Study Partner",
      subtitle: "Team up and learn together effectively",
      to: "/study-partner",
      bg: "[#59A6E8]",
      image: studyPartnerImg,
    },
    {
      title: "Aptitude Questions",
      subtitle: "Sharpen your quantitative and logical skills",
    ...
    {
      title: "Core Subjects",
      subtitle: "OS, DBMS, CN – concise notes and Q&A",
      to: "/resources",
      bg: "[#9B7AE1]",
      image: coreSubjectsImg,
    },
    {
      title: "HR Round Questions",
      subtitle: "Prepare smart answers for behavioral rounds",
      to: "/hr",
      bg: "[#D6AE57]",
      image: hrImg,
    },
